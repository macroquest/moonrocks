local git_ref = 'fe10eab6cacff239ec61f4456e793bed15703aaf'
local modrev = '0.0.3'
local specrev = '1'

local repo_url = 'https://github.com/purarue/tree-sitter-rifleconf'

rockspec_format = '3.0'
package = 'tree-sitter-rifleconf'
version = modrev ..'-'.. specrev

description = {
  summary = 'tree-sitter parser for rifleconf',
  labels = { 'neovim', 'tree-sitter' } ,
  homepage = 'https://github.com/purarue/tree-sitter-rifleconf',
  license = 'UNKNOWN'
}
...
source = {
  ...
  dir = 'tree-sitter-rifleconf-' .. 'fe10eab6cacff239ec61f4456e793bed15703aaf',
}
