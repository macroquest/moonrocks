...
source = {
  url = "https://github.com/treadwelllane/lua-santoku-cli/releases/download/0.0.300-1/santoku-cli-0.0.300-1.tar.gz",
}
...
dependencies = {
  ...
  "santoku-make >= 0.0.148-1",
  "santoku-mustache >= 0.0.9-1",
  "argparse >= 0.7.1-1"
}
