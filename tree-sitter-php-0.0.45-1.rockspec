local git_ref = '182f034cd19a2f41f751eee0d57378fbfc96ab3a'
local modrev = '0.0.45'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-php_only == 0.0.49' } 
...
source = {
  ...
  dir = 'tree-sitter-php-' .. '182f034cd19a2f41f751eee0d57378fbfc96ab3a',
}
