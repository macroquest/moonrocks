package = "hc3emu"
version = "1.1.10-1" -- updated version to match the new version number
source = {
   url = "git://github.com/jangabrielsson/hc3emu",
   tag = "v1.1.10", -- updated tag to match version
}
description = {
...
build = {
   ...
   modules = {
      ...
      ["hc3emu.config"] = "src/hc3emu/config.lua",
      ...
      ["hc3emu.eventdispatcher"] = "src/hc3emu/eventdispatcher.lua",
      ["hc3emu.api"] = "src/hc3emu/api.lua",
      ["hc3emu.resources"] = "src/hc3emu/resources.lua",
      ["hc3emu.helper"] = "src/hc3emu/helper.lua",      
      ...
      ["hc3emu.terminal"] = "src/hc3emu/terminal.lua"
  },
