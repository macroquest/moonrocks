local git_ref = '7d07b41ce2d442ca9a90ed85d0075eccc17ae315'
local modrev = '0.0.51'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-php_only == 0.0.55' } 
...
source = {
  ...
  dir = 'tree-sitter-php-' .. '7d07b41ce2d442ca9a90ed85d0075eccc17ae315',
}
