local git_ref = 'de11d0bcec62b8ed6b0c7edd55051042f37b8b05'
local modrev = '0.0.50'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-php_only == 0.0.54' } 
...
source = {
  ...
  dir = 'tree-sitter-php-' .. 'de11d0bcec62b8ed6b0c7edd55051042f37b8b05',
}
