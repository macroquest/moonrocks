local git_ref = 'fad991865fee927dd1de5e172fb3f08ac674d914'
local modrev = '0.0.35'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-hcl == 0.0.34' } 
...
source = {
  ...
  dir = 'tree-sitter-hcl-' .. 'fad991865fee927dd1de5e172fb3f08ac674d914',
}
