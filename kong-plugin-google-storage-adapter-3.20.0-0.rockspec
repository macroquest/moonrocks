...
local package_version = "3.20.0"
local rockspec_revision = "0"
local full_version = package_version .. "-" .. rockspec_revision
local storage_path = "https://storage.googleapis.com/cloud-site-builder-bucket-prod/"

package = package_name
version = full_version
supported_platforms = { "linux", "macosx" }
source = {
  url = storage_path .. package_name .. "-" .. full_version .. ".tar.gz"
}
