-- This file was generated by scripts/gen_rockspec.py on 2025-05-16
package = "kong-plugin-ddtrace"
version = "0.2.3-1"

source = {
    url = "https://github.com/datadog/kong-plugin-ddtrace/archive/v0.2.3.zip",
    dir = "kong-plugin-ddtrace-0.2.3",
}
