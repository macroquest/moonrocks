local git_ref = 'b2278dbac9d58b02653fe6a8530ccebc492e4ed4'
local modrev = '0.0.44'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-php_only == 0.0.46' } 
...
source = {
  ...
  dir = 'tree-sitter-php-' .. 'b2278dbac9d58b02653fe6a8530ccebc492e4ed4',
}
