local git_ref = 'b131ccbf414a720cce088610539241a1eb170054'
local modrev = '0.0.38'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-ecma == 0.0.32', 'tree-sitter-jsx == 0.0.30' } 
...
source = {
  ...
  dir = 'tree-sitter-javascript-' .. 'b131ccbf414a720cce088610539241a1eb170054',
}
