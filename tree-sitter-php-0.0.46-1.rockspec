local git_ref = '1269143868747e3b8e50f221ca0a2e5a1a2f2b44'
local modrev = '0.0.46'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-php_only == 0.0.50' } 
...
source = {
  ...
  dir = 'tree-sitter-php-' .. '1269143868747e3b8e50f221ca0a2e5a1a2f2b44',
}
