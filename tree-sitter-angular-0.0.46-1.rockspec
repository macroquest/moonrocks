local git_ref = 'd2f388435b062fdd6b3c386db6c23db2da67e578'
local modrev = '0.0.46'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-html == 0.0.40', 'tree-sitter-html_tags == 0.0.29' } 
...
source = {
  ...
  dir = 'tree-sitter-angular-' .. 'd2f388435b062fdd6b3c386db6c23db2da67e578',
}
