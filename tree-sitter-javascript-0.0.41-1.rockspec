local git_ref = '58404d8cf191d69f2674a8fd507bd5776f46cb11'
local modrev = '0.0.41'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-ecma == 0.0.33', 'tree-sitter-jsx == 0.0.30' } 
...
source = {
  ...
  dir = 'tree-sitter-javascript-' .. '58404d8cf191d69f2674a8fd507bd5776f46cb11',
}
