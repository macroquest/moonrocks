local git_ref = '87be254e12169240a0e0214dbee5e208df96fa75'
local modrev = '0.0.40'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-dtd == 0.0.39' } 
...
source = {
  ...
  dir = 'tree-sitter-xml-' .. '87be254e12169240a0e0214dbee5e208df96fa75',
}
