local git_ref = 'f6bf6e35eb0b95fbadea4bb39cb9709507fcb181'
local modrev = '0.0.30'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-tsv == 0.0.30' } 
...
source = {
  ...
  dir = 'tree-sitter-csv-' .. 'f6bf6e35eb0b95fbadea4bb39cb9709507fcb181',
}
