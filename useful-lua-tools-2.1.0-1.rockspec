...
description = {
   ...
   detailed = [[
      Useful Lua Tools is a comprehensive toolkit providing various utility functions for Lua development. Created by Some Random Gamer (SRG), this library offers helpful tools to simplify common programming tasks.
   ]],
