local git_ref = '1c09d45d8a108790a31c92d2c089418f21d56c82'
local modrev = '2.3.2'
local specrev = '1'
...
The possibilities are endless, and the only limit is your creativity!]],
  labels = { 'cord', 'cord-nvim', 'discord', 'discord-rich-presence', 'lua', 'neovim', 'neovim-plugin', 'neovim-plugins', 'nvim', 'plugin', 'rich-presence', 'rpc', 'rust' } ,
...
source = {
  ...
  dir = 'cord.nvim-' .. '1c09d45d8a108790a31c92d2c089418f21d56c82',
}
