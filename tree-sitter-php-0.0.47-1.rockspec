local git_ref = '5b5627faaa290d89eb3d01b9bf47c3bb9e797dea'
local modrev = '0.0.47'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-php_only == 0.0.51' } 
...
source = {
  ...
  dir = 'tree-sitter-php-' .. '5b5627faaa290d89eb3d01b9bf47c3bb9e797dea',
}
